...
Здесь а, b, с длины сторон треугольника.
...
2-указанные числа a, b, с не могут являться длинами сторон треугольника;
3 - стороны а, b, с образуют треугольник.
Проверку параметров a, b, с проводить именно в таком порядке.
Прочитайте из входного потока строку, содержащую три числа, разделенных пробелами, командой:
a, b, c = map(int, input().split())
Затем, создайте объект tr класса TriangleChecker и передайте ему прочитанные значения a, b, с. 
